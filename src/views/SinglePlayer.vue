        ...
        <header>
            ...
            <aside class="flex items-center justify-between mb-4">
                <nav class="flex space-x-4" aria-label="Tabs">
                    <a @click.prevent="changeView" href="#" class="px-3 py-2 font-medium text-sm rounded-md" :class="viewStats ? 'bg-gray-100 text-gray-700' : 'text-gray-500 hover:text-gray-700'">
                        Stats
                    </a>
                    <a @click.prevent="changeView" href="#" class="px-3 py-2 font-medium text-sm rounded-md" :class="viewStats ? 'text-gray-500 hover:text-gray-700' : 'bg-gray-100 text-gray-700'">
                        Results
                    </a>
                </nav>

                <select v-model="season" class="block form-input transition duration-150 ease-in-out text-sm sm:leading-5">
