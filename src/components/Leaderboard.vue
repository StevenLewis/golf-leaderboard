                ...
                <div class="align-middle inline-block min-w-full overflow-hidden md:rounded-lg md:shadow md:border md:border-gray-100">
                    <table class="min-w-full">
                        <thead>
                            ...
                            <th class="px-4 py-3 md:px-6 md:py-3 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Qualifying Games</th>
                            <th class="px-4 py-3 md:px-6 md:py-3 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Total Score</th>
                            <th class="px-4 py-3 md:px-6 md:py-3 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Average</th>
                            <th class="px-4 py-3 md:px-6 md:py-3 bg-gray-100 text-center md:text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">10th Best</th>
                            <th class="px-4 py-3 md:px-6 md:py-3 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">9th Best</th>
                            <th class="px-4 py-3 md:px-6 md:py-3 bg-gray-100 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">8th Best</th>
                        </thead>
                        <tbody>
                            <router-link :to="{ name: 'players.show', params: { id: player.id } }" v-for="(player, index) in leaderboard" :key="player.id" :class="backgroundColor(index)" class="table-row">
                                ...
                                <td class="px-4 py-3 md:px-6 md:py-4 whitespace-no-wrap text-sm leading-5 font-medium text-gray-500">{{ player.totalQualifyingGames }}</td>
                                <td class="px-4 py-3 md:px-6 md:py-4 whitespace-no-wrap text-sm leading-5 font-medium text-gray-500">{{ player.totalQualifyingScore }}</td>
                                <td class="px-4 py-3 md:px-6 md:py-4 whitespace-no-wrap text-sm leading-5 font-medium text-gray-500">{{ player.qualifyingAverage }}</td>
                                <td class="px-4 py-3 md:px-6 md:py-4 whitespace-no-wrap text-sm text-center md:text-left leading-5 font-medium text-gray-500">{{ player.scoresToBeat[0] }}</td>
                                <td class="px-4 py-3 md:px-6 md:py-4 whitespace-no-wrap text-sm leading-5 font-medium text-gray-500">{{ player.scoresToBeat[1] }}</td>
                                <td class="px-4 py-3 md:px-6 md:py-4 whitespace-no-wrap text-sm leading-5 font-medium text-gray-500">{{ player.scoresToBeat[2] }}</td>
                            </router-link>
                        </tbody>
                    </table>
                </div>
