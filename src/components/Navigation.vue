<template>
    <div class="flex justify-between h-16">
        <div class="flex">
            <div class="hidden sm:-my-px sm:flex">
                <router-link
                    ...
                    :class="linkClasses('leaderboard.show')">
                    Leaderboard
                </router-link>
                <router-link
                    :to="{ name: 'competitions.index' }"
                    class="mr-8 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 focus:outline-none transition duration-150 ease-in-out"
                    :class="linkClasses('competitions.index')">
                    Competitions
                </router-link>
                <router-link
        ...
        <div class="flex">
            ...
            <template v-else>
                <router-link to="login" class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 focus:outline-none transition duration-150 ease-in-out border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:text-gray-700 focus:border-gray-300">
                    Login
                </router-link>
            </template>
        </div>
